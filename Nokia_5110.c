...
sPCD8544Digit pcd8544_symbol[] =
{
        ...
        {{1, 1, 1, 1, 1, 1, 1}, {0x00, 0x28, 0x28, 0x28, 0x28, 0x28, 0x00}}, // '='
        {{1, 1, 1, 1, 1, 1, 1}, {0x00, 0x23, 0x13, 0x08, 0x64, 0x62, 0x00}}  // '%'
};
...
void printOnLCD(uint8_t ch)
{
    ...
    switch(ch)
    {
        ...
        case '=':
            digit.type = &pcd8544_symbol[9].type[0];
            digit.data = &pcd8544_symbol[9].data[0];
            PCD8544Column++;
            break;
               
        case '%':
            digit.type = &pcd8544_symbol[10].type[0];
            digit.data = &pcd8544_symbol[10].data[0];
            PCD8544Column++;
            break;
